<div class="car-example"> <!-- Car example -->
  ...
  <div class="car-example-content"> <!-- Car example content -->      
    <div id="carousel-car-example" class="carousel slide" data-ride="carousel">                    
                        ...
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="last"><strong>{$poistovna->nenie}</strong></td>          
                            </tr>
                            {/foreach}
                          </tbody>
                        </table>  
      ...
      <!-- Controls -->
      <a class="left carousel-control" href="#carousel-car-example" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="right carousel-control" href="#carousel-car-example" role="button" data-slide="next">
        <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
        <span class="sr-only">Next</span>
      </a>   
    </div>
    <div class="car-example-buttons">
      <a href="{$porovnanie_podstranka}" rel="nofollow" class="btn btn-medium main-btn"><span>{$porovnanie_button}</span></a>
    </div>
    <p class="pexample">
      {$poznamka}
    </p>
