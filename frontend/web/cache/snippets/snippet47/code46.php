<!--header -->
<div class="poster comparator-poster" style="{if !empty(pozadie)} background-image: url({$pozadie}) {/if}">
  <div class="poster-content poster-boxed-content">
    ...
    <div class="comp-form">
      <div class="row">     
        ...
        <div class="col-xs-6">           
          <button id="big-filter-button" class="btn btn-lg main-btn">{$slovnik->porovnat_ponuky}</button>
        </div>  
      </div>
    </div>  
  </div>
