...
<head>
  ...
  <title>Home Credit půjčka online žádosť</title>
...
<div class="top-info">
  ...
  <main>
		<div id="page-content">
		    <div class="wrapper">
		        <div class="container">
		            <div class="row"><div id="content" class="col-md-12"><div class="row"><div class="col-md-6 "  ><div class="box"><div class="main-form" id="form">
  <h3>Vyplňte nezávaznou žádost</h3>
  <iframe src="http://hyperpartner.cz/cz/client/form/home-credit-classic?redirectUrl=http%3A%2F%2Fwww.financeprehledne.cz%2Fthanks%2Fcz%2Fpujcky%2Fdekujeme_hc_classic%2F&amp;css=http%3A%2F%2Fwww.financeprehledne.cz%2Fpublic%2Ftemplate%2Ftemplateone%2Fcss%2Fpublic%2Fform%2Fcz%2Fhc_cz.css" style="border: 0; overflow: hidden; height: 517px; width: 100%;" frameborder="0"></iframe>
</div>
...
<script type="text/javascript">
 $('iframe').iFrameResize();
</script></div></div><div class="col-md-6 "  ><div class="box"><div class="kroky kroky-number-with-dot">
  <h3>Jak probíhá žádost?</h3>
  <ol>
        <li>Vyplnit a odeslat vstupní formulář s osobními údaji.</li>
        <li>Doložit potřebné dokumenty a počkat si na vyjádření společnosti.</li>
        <li>Očekávat peníze.</li>
      </ol>
</div></div></div></div></div>
					</div>
		        </div>
