...
<head>
  ...
  <title>Zaimo půjčka časté otázky</title>
...
<div class="top-info">
  ...
  <main><div id="page-header"><div class="wrapper header-wrapper"style="background: #F00;">
  ...
  <div class="poster-content pull-left" style="color : ">
	  <div class="main-box">
        <h1>Zaimo půjčka</h1>
        <h3>Časté otázky a odpovědi</h3>
        <ul>
                    <li>Půjčka od 15&nbsp;000 do 75&nbsp;000 Kč</li>
                    <li>Splatnost od 6 do 36 měsíců</li>
                    <li>Rychlé posouzení žádosti do jedné minuty</li>
                  </ul>
        <div class="actions">
          <a class="btn main-btn btn-xl" href="/zaimo-pujcka/caste-otazky/../zadost/">Chci si půjčit</a> 
        </div>  
  ...
  <script>
    getPerson('person', '15&nbsp;000', '75&nbsp;000', 'cz', '250');
  </script>
</div></div></div></div>
		            </div>
		        </div><div class="wrapper ">
		            <div class="container"><div class="row"><div class="col-md-12 "  ><div class="box"><div class="sub-menu">
  <ul>
        <li><a href="/zaimo-pujcka/caste-otazky/../">Zaimo půjčka</a></li>
        <li><a href="/zaimo-pujcka/caste-otazky/../caste-otazky/">Časté otázky</a></li>
        <li><a href="/zaimo-pujcka/caste-otazky/../recenze/">Recenze</a></li>
        <li>
      <a href="/zaimo-pujcka/caste-otazky/../zadost/">Online žádost</a>
    </li>
  </ul>
</div>
<script> <!--sirka stlpcov podla ich poctu -->
  ...
  polozky.css("width", sirka +  "%");
		...
		<div id="page-content">
		    <div class="wrapper">
		        <div class="container">
		            <div class="row"><div id="content" class="col-md-8"><div class="row"><div class="col-md-12 "  ><div class="box"><h2>Časté otázky&nbsp;</h2><h4>1. Jak probíhá schvalování žádosti?</h4><p>Schvalovací proces probíhá 24 hodin, 7 dnů v týdnu. Jakmile žádost vyplníte a odešlete, během několika minut obdržíte kladné či záporné vyjádření.&nbsp;</p><h4>2. Za jak dlouho se dozvím, zda mi bude půjčka poskytnuta či nikoli?</h4><p>Po odeslání žádosti vám na e-mail přijde vyjádření o schválení či zamítnutí půjčky. Informaci byste měl/a obdržet během několika minut.&nbsp;</p><h4>3. Nedostal/a jsem žádné vyjádření ohledně zaslané žádosti. Co teď?</h4><p>Zkontrolujte složku „spam“, kam cizí e-maily velmi rády padají. Pokud zde e-mail nenaleznete, kontaktujte zástupce společnosti.&nbsp;</p><h4>4. Musím prokazovat společnosti příjem?</h4><p>Ne. Společnost při posuzování žádosti nepotřebuje znát výši vašich příjmů.&nbsp;</p><h4>5. Nahlíží společnost do registru dlužníků?</h4><p>Společnost&nbsp;do registrů dlužníků nenahlíží. Pokud zde tedy máte záznam, rozhodně to neznamená, že byste půjčku nemohli získat.&nbsp;</p><h4>6. Za jak dlouho peníze obdržím?</h4><p>Peníze jsou vypláceny prostřednictvím platební brány The Pay. Předtím je ale nutné zaslat na účet společnosti ověřovací poplatek ve výši 1 koruny. Jakmile poplatek dorazí, finance jsou obratem odesílány.</p><h4>7. Proč musím odesílat ověřovací poplatek?</h4><p>Jednokorunový ověřovací poplatek slouží k ověření bankovního účtu žadatele o půjčku.&nbsp;</p><h4>8. Mám problém se splácením půjčky. Jak jej řešit?</h4><p>Neprodleně kontaktujte zástupce společnosti a spravte jej o své aktuální situaci. Společně se můžete dohodnout na odkladu splátek nebo novém splátkovém kalendáři.&nbsp;</p><h4>9. Musím podepisovat nějaké dokumenty? Dostanu je poštou?</h4><p>Společnost veškeré dokumenty zasílá e-mailem. Nemusíte tak čekat na poštovní zásilky, které schvalovací proces zbytečně natahují.&nbsp;</p><h4>10. Kde najdu informace o splatnosti a parametrech půjčky?</h4><p>Veškeré informace o splatnosti i parametrech naleznete na oficiálních stránkách půjčky <a href="https://www.zaimo.cz/" target="">zaimo.cz</a>.&nbsp;</p> <p></p><div class="cta-box cta-box-with-note-cz-pozicky">
  <a class="btn main-btn btn-lg main-btn-big" href="/zaimo-pujcka/caste-otazky/../zadost/">Chci si půjčit</a>
</div></div></div></div></div><div id="sidebar" class="col-md-4 "><div class="row"><div class="col-md-12 "  ><div class="box"><div class="vyhody">
  <a id="vyhody"></a>
  <h3>Výhody</h3>
  <ul class="vyhody">
    <li>Výše půjčky od <b>15&nbsp;000 do 75&nbsp;000 Kč</b></li>
    <li>Splatnost <b>6 - 36 měsíců</b></li>
        <li>Online sjednání a vyřízení</li>
        <li>Rychlé posouzení žádosti</li>
        <li>Bezplatné sjednání, vyřízení a vedení půjčky</li>
        <li>Půjčka bez skrytých poplatků </li>
        <li>Rychlé zaslání peněz na bankovní účet</li>
      </ul>
  <div class="clearfix"></div>
  ...
  <ul class="vyhody vyhody-">
        ...
        <li>Vlastní bankovní účet v české bance </li>
  ...
  <ol>
        <li>Vyplníte žádost, kde navolíte parametry půjčky.</li>
        <li>Vyplníte osobní údaje, e-mail a telefonní číslo.</li>
        <li>Zašlete ověřovací poplatek ve výši 1 Kč.</li>
        <li>Po obdržení platby společnost obratem posílá peníze. </li>
      </ol>
</div></div></div></div><div class="row"><div class="col-md-12 "  ><div class="box"><div class="kategorie_box" data-tags-category-attributes="t_3,t_6,t_11,t_10,t_17">
  <h3>Vlastnosti půjčky</h3>
  <ul>
        <li class="tag-item" id="t_4"><a href="/bankovni-pujcky/">Bankovní půjčky</a></li>
        <li class="tag-item" id="t_3"><a href="/nebankovni-pujcky/">Nebankovní půjčky</a></li>
        <li class="tag-item" id="t_11"><a href="/pujcky-bez-rucitele/">Půjčky bez ručitele</a></li>
        <li class="tag-item" id="t_10"><a href="/pujcky-bez-registru/">Půjčky bez registru</a></li>
        <li class="tag-item" id="t_6"><a href="/pujcky-pred-vyplatou/">Půjčky před výplatou</a></li>
        <li class="tag-item" id="t_6"><a href="/rychla-pujcka-ihned/">Rychlá půjčka ihned</a></li>
        <li class="tag-item" id="t_17"><a href="/pujcky-bez-dolozeni-prijmu/">Půjčky bez doložení příjmu</a></li>
        <li class="tag-item" id="t_28"><a href="/pujcky-v-hotovosti/">Půjčky v hotovosti</a></li>
        <li class="tag-item" id="t_23"><a href="/pujcky-pro-duchodce/">Půjčky pro důchodce</a></li>
        <li class="tag-item" id="t_14"><a href="/prvni-pujcka-zdarma/">První půjčka zdarma</a></li>
        <li class="tag-item" id="t_26"><a href="/pujcky-na-materske/">Půjčky na mateřské</a></li>
        <li class="tag-item" id="t_19"><a href="/pujcky-pro-studenty/">Půjčky pro studenty</a></li>
        <li class="tag-item" id="t_6"><a href="/nejschvalovanejsi-pujcky/">Nejschvalovanější půjčky</a></li>
        <li class="tag-item" id="t_19"><a href="/pujcky-na-obcansky-prukaz/">Půjčky na občanský průkaz</a></li>
        <li class="tag-item" id="t_21"><a href="/pujcky-pro-zivnostniky/">Půjčky pro živnostníky</a></li>
            <li class="amount-item" id="1000"><a href="/pujcka-1000-ihned/">Půjčka 1000 ihned</a></li>
        <li class="amount-item" id="2000"><a href="/pujcka-2000-ihned/">Půjčka 2000 ihned</a></li>
        <li class="amount-item" id="3000"><a href="/pujcka-3000-ihned/">Půjčka 3000 ihned</a></li>
        <li class="amount-item" id="4000"><a href="/pujcka-4000-akce-ihned/">Půjčka 4000 akce ihned</a></li>
        <li class="amount-item" id="5000"><a href="/pujcka-do-5000/">Půjčka do 5000</a></li>
        <li class="amount-item" id="10000"><a href="/pujcka-10000-ihned/">Půjčka 10000 ihned</a></li>
        <li class="amount-item" id="20000"><a href="/pujcka-20000-ihned/">Půjčka 20000 ihned</a></li>
        <li class="amount-item" id="30000"><a href="/pujcka-30000-ihned/">Půjčka 30000 ihned</a></li>
        <li class="amount-item" id="40000"><a href="/pujcka-4000-akce-ihned/">Půjčka 4000 akce ihned</a></li>
        <li class="amount-item" id="50000"><a href="/pujcka-50000-ihned/">Půjčka 50000 ihned</a></li>
      </ul>
</div>
