...
use backend\components\AjaxLoading\AjaxLoadingAsset;

AjaxLoadingAsset::register($this)

?>

<div class="ajax-loading ajax-loading-overlay hidden">
    <div class="ajax-loading-icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="123" height="123" fill="#20F3C9">
