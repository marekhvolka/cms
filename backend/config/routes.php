...
return  [
            ...
            '<module>/<controller>/<action>/<type:[a-zA-Z0-9-]+>/<portalId:[a-zA-Z0-9-]+>' => '<module>/<controller>/<action>/',
            '<module>/<controller>/<action>/<type:[a-zA-Z0-9-]+>/<portalId:[a-zA-Z0-9-]+>/<pageId:[a-zA-Z0-9-]+>' => '<module>/<controller>/<action>/',
