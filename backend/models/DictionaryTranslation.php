 ...
 */
class DictionaryTranslation extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['word_id'], 'exist', 'skipOnError' => true, 'targetClass' => Dictionary::className(), 'targetAttribute' => ['word_id' => 'id']],
    ...
    {
        return $this->hasOne(Dictionary::className(), ['id' => 'word_id']);
    }
