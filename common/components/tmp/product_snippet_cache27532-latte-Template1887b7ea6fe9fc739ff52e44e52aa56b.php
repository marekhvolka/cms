<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/postova_banka_pozicka/product_snippet_cache27532.latte

class Template1887b7ea6fe9fc739ff52e44e52aa56b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('25e405c73e', 'html')
;
//
// main template
//
...
$snippet->vyska = '5 000 €';
$snippet->pocet_splatok = '48';
$snippet->splatka = '129 €';
$snippet->urok = '10,9 %';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky poskytovateľa ku dňu 12. 10. 2015. <br>';
