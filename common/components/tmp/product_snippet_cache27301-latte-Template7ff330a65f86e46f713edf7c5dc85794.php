<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/unicredit_optimalizacia_sk/product_snippet_cache27301.latte

class Template7ff330a65f86e46f713edf7c5dc85794 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8e6baae961', 'html')
;
//
// main template
//
...
/* Snippet values */
/* Var values  */
$snippet->nadpis = 'Tabuľka splátok pri spojení pôžičiek v UniCredit Bank';
$snippet->platnost = '* Uvedené hodnoty sú platné k dátumu 24. 4. 2015. ';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '1 000,00 €', 'pocet_splatok' => '60', 'splatka' => '23.47 €', 'rpmn' => '17.50 %', 'urok' => '7.90 %', 'poplatok' => '0 €', 'celkom' => '1 408,00 €', 'celkova_uspora' => '', 'splatnost' => '24. 4. 2020',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '2 500,00 €', 'pocet_splatok' => '84', 'splatka' => '45,99 €', 'rpmn' => '14,84 %', 'urok' => '7,90 %', 'poplatok' => '0 €', 'celkom' => '3 863,00 €', 'celkova_uspora' => '', 'splatnost' => '24. 4. 2022',), 
'2' => (object) array(
'ponuka' => 'Pôvodná', 'vyska' => '6 000,00 €', 'pocet_splatok' => '96', 'splatka' => '101.59 €', 'rpmn' => '14.40 %', 'urok' => '7,90 %', 'poplatok' => '0 €', 'celkom' => '9 752,00 €', 'celkova_uspora' => '', 'splatnost' => '24. 4. 2023',), 
);
