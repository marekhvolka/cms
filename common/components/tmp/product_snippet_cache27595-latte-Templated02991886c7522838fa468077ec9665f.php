<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/equabank_refinancovani/product_snippet_cache27595.latte

class Templated02991886c7522838fa468077ec9665f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c0db483a93', 'html')
;
//
// main template
//
...
$snippet->vyska = '175 000 Kč';
$snippet->pocet_splatok = '69 měsíců';
$snippet->splatka = '3 422 Kč';
$snippet->urok = '10,86 %';
$snippet->poplatok = '150 Kč';
$snippet->rpmn = '11,43 %';
$snippet->celkom = '236 118 Kč';
$snippet->platnost = 'Reprezentativní příklad je čerpán z oficiální stránky poskytovatele k datu: 4. 12. 2015.';
