<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/vub_ucet/product_snippet_cache27558.latte

class Template4775323db239267307d2287cdf3fd122 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f7c1f672ef', 'html')
;
//
// main template
//
