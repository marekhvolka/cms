<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/sberbank_pujcka/product_snippet_cache27574.latte

class Template8ed355c91862fc487ca5c7ff0deee740 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('30d04d9b81', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 21. 11. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '24', 'splatka' => '4 763 Kč', 'urok' => '12,99 %', 'poplatok' => '0 Kč', 'rpmn' => '14,00 %', 'celkom' => '114 312 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '200 000 Kč', 'pocet_splatok' => '60', 'splatka' => '4 263 Kč', 'urok' => '9,99 %', 'poplatok' => '0 Kč', 'rpmn' => '10,61 %', 'celkom' => '255 780 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '96', 'splatka' => '7 355 Kč', 'urok' => '8,99 %', 'poplatok' => '0 Kč', 'rpmn' => '9,51 %', 'celkom' => '706 080 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
