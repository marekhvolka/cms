<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/ferratum_pujcka/product_snippet_cache27640.latte

class Template55534b743ce55b034c40b3999b24099a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('dc7008e8e2', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '2 000 Kč', 'pocet_splatok' => '1', 'splatka' => '21', 'rpmn' => '4 105 %', 'urok' => '417,14 %', 'poplatok' => '480 Kč', 'celkom' => '2 480 Kč', 'celkova_uspora' => '', 'splatnost' => '10. 8. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '3 000 Kč', 'pocet_splatok' => '1', 'splatka' => '21 ', 'rpmn' => '4 105 %', 'urok' => '417,14 %', 'poplatok' => '720 Kč', 'celkom' => '3 720 Kč', 'celkova_uspora' => '', 'splatnost' => '10. 8. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '4 000 Kč', 'pocet_splatok' => '1', 'splatka' => '21 ', 'rpmn' => '4 105 %', 'urok' => '417,14 %', 'poplatok' => '960 Kč', 'celkom' => '4 960 Kč', 'celkova_uspora' => '', 'splatnost' => '10. 8. 2015',), 
);
