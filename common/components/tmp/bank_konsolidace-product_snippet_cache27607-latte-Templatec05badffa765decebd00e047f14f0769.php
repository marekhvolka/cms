<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/repujcka_od equa bank_konsolidace/product_snippet_cache27607.latte

class Templatec05badffa765decebd00e047f14f0769 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('286eceef0c', 'html')
;
//
// main template
//
...
$snippet->splatka = '2 369 Kč';
$snippet->urok = '9,90 %';
$snippet->rpmn = '10,36 %';
$snippet->celkom = '284 280 Kč';
