<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/tesco_sk/product_snippet_cache27287.latte

class Templatec4ef3661b678a4ac83a472f0da85dd67 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b2d3898f35', 'html')
;
//
// main template
//
...
$snippet->urok = '15,82 %';
$snippet->poplatok = '0 €';
$snippet->celkom = '9 996 €';
$snippet->platnost = '* Reprezentatívny príklad platí k dátumu: 31. 8. 2015.';
