<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/slovenska_sporitelna_ucet/product_snippet_cache27556.latte

class Template92d5774f955e76a0cc2b07169e61dfd6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a84760b834', 'html')
;
//
// main template
//
