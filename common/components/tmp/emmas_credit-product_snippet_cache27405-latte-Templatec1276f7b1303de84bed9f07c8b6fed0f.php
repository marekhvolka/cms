<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/emmas_credit/product_snippet_cache27405.latte

class Templatec1276f7b1303de84bed9f07c8b6fed0f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('10fa246a04', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni: 29. 7. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '500 Kč ', 'pocet_splatok' => '1', 'splatka' => '22', 'rpmn' => '-', 'urok' => '110 Kč', 'poplatok' => '-', 'celkom' => '610 Kč', 'celkova_uspora' => '', 'splatnost' => '20. 8. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '2 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '-', 'urok' => '600 Kč', 'poplatok' => '-', 'celkom' => '2 600 Kč', 'celkova_uspora' => '', 'splatnost' => '28. 8. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '3 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '-', 'urok' => '900 Kč', 'poplatok' => '-', 'celkom' => '3 900 Kč', 'celkova_uspora' => '', 'splatnost' => '28. 8. 2015',), 
);
