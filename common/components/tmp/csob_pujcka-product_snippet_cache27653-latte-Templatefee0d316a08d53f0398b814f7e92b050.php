<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/csob_pujcka/product_snippet_cache27653.latte

class Templatefee0d316a08d53f0398b814f7e92b050 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('199c7f652f', 'html')
;
//
// main template
//
