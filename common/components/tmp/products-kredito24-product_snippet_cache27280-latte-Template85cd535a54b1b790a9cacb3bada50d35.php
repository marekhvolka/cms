<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/kredito24/product_snippet_cache27280.latte

class Template85cd535a54b1b790a9cacb3bada50d35 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('fed87a3288', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '3 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30 dnů', 'rpmn' => '-', 'urok' => '-', 'poplatok' => '900 Kč', 'celkom' => '3 900 Kč', 'celkova_uspora' => '', 'splatnost' => '22. 8. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '5 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30 dnů', 'rpmn' => '-', 'urok' => '-', 'poplatok' => '1 500 Kč', 'celkom' => '6 500 Kč', 'celkova_uspora' => '', 'splatnost' => '22. 8. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '10 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30 dnů', 'rpmn' => '-', 'urok' => '-', 'poplatok' => '3 000 Kč', 'celkom' => '13 000 Kč', 'celkova_uspora' => '', 'splatnost' => '22. 8. 2015',), 
);
