<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/zuno_refinancovanie_sk/product_snippet_cache27303.latte

class Template52d0806cc10b3fb0c33e1d79c660f43a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c14647e000', 'html')
;
//
// main template
//
...
/* Snippet values */
/* Var values  */
$snippet->nadpis = 'Refinancovanie pôžičky v ZUNO - tabuľka splátok';
$snippet->platnost = '*Všetky uvedené údaje sú platné k dátumu 6. 5. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => 'Pôvodný úver', 'vyska' => '7 000,00 €', 'splatka' => '153,00 €', 'urok' => 'Do 11,49 %', 'rpmn' => '7,72 %', 'poplatok' => '0 €', 'pocet_splatok' => '54', 'celkom' => '7 647,40 €', 'celkova_uspora' => '-', 'splatnost' => '6. 11. 2019',), 
'1' => (object) array(
'ponuka' => 'Ponuka od ZUNO', 'vyska' => '6 087 €', 'splatka' => '131,40 €', 'urok' => '6,90 %', 'rpmn' => '7,10 %', 'poplatok' => '0 €', 'pocet_splatok' => '54', 'celkom' => '7 095,60 €', 'celkova_uspora' => '551,80 €', 'splatnost' => '6. 11. 2019',), 
);
