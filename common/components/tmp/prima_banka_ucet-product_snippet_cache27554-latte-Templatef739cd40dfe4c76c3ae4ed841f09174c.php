<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/prima_banka_ucet/product_snippet_cache27554.latte

class Templatef739cd40dfe4c76c3ae4ed841f09174c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ee665325a8', 'html')
;
//
// main template
//
