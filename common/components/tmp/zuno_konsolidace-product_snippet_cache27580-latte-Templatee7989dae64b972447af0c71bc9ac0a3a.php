<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zuno_konsolidace/product_snippet_cache27580.latte

class Templatee7989dae64b972447af0c71bc9ac0a3a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6921726b22', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => 'Aktuální výše závazku   ', 'vyska' => '180 000 Kč   ', 'pocet_splatok' => '84 ', 'splatka' => '3 299 Kč', 'urok' => '13,27 %', 'poplatok' => '', 'rpmn' => '14,2 %', 'celkom' => '277 116 Kč', 'celkova_uspora' => '-', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => 'Nová nabídka', 'vyska' => '180 000 Kč   ', 'pocet_splatok' => '84', 'splatka' => '2 987 Kč', 'urok' => '', 'poplatok' => '', 'rpmn' => '', 'celkom' => '251 222 Kč', 'celkova_uspora' => '44 441 Kč', 'splatnost' => '',), 
);
