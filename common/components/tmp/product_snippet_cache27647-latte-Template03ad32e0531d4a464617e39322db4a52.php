<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/mbank_refinancovanie/product_snippet_cache27647.latte

class Template03ad32e0531d4a464617e39322db4a52 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('36b0c539de', 'html')
;
//
// main template
//
...
$snippet->platnost = '* Uvedené hodnoty sú čerpané od poskytovateľa k dátumu: 10. 2. 2016.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '2 000 €', 'pocet_splatok' => '84', 'splatka' => '33,10 €', 'urok' => '9,9 % p.a.', 'poplatok' => '0 €', 'rpmn' => '10,36 % p.a.', 'celkom' => '2 780,33 €', 'celkova_uspora' => '', 'splatnost' => '',), 
);
