<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/cetelem_pujcka/product_snippet_cache27370.latte

class Template4f57294db460702699d7e7dda752b13a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a3ecd995f4', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '20 000 Kč', 'pocet_splatok' => '48', 'splatka' => '577 Kč', 'rpmn' => '15,89 %', 'urok' => '14,84 %', 'poplatok' => '-', 'celkom' => '26 640 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '150 000 Kč', 'pocet_splatok' => '60', 'splatka' => '3 229 Kč', 'rpmn' => '9,27 %', 'urok' => '8,89 %', 'poplatok' => '-', 'celkom' => '186 360 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '200 000 Kč', 'pocet_splatok' => '96', 'splatka' => '3 719 Kč', 'rpmn' => '13,16 %', 'urok' => '12,43 %', 'poplatok' => '-', 'celkom' => '343 392 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
