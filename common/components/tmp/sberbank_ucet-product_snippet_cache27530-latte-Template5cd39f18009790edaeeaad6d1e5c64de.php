<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/sberbank_ucet/product_snippet_cache27530.latte

class Template5cd39f18009790edaeeaad6d1e5c64de extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b2377752ce', 'html')
;
//
// main template
//
