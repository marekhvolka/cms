<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/mpujcka/product_snippet_cache27354.latte

class Templatee16b1d88992e3868886502fec6efe478 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5a1f8d448e', 'html')
;
//
// main template
//
...
$snippet->splatka = '1 060 Kč';
$snippet->rpmn = '10,36 %';
$snippet->urok = '9,9 %';
$snippet->poplatok = '0 Kč';
$snippet->celkom = '63 594 Kč';
