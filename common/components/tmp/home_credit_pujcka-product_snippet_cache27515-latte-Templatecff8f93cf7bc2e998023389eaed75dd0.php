<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/home_credit_pujcka/product_snippet_cache27515.latte

class Templatecff8f93cf7bc2e998023389eaed75dd0 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c866a59328', 'html')
;
//
// main template
//
...
$snippet->splatka = '999 Kč';
$snippet->rpmn = '13,7 %';
$snippet->urok = '12,88 % ';
$snippet->poplatok = '0 Kč';
$snippet->celkom = '75 439 Kč **';
$snippet->splatnost = '15. 7. 2022';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 17. 8. 2015.<br>**V případě včasného splacení a vrácení 1/4 úroků';
