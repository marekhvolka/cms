<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/ferratum_pozicka/product_snippet_cache27439.latte

class Template6de08b4e2e53d0313001030769aac247 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6de3d91038', 'html')
;
//
// main template
//
...
$snippet->rpmn = '33 %';
$snippet->urok = '-';
$snippet->poplatok = '2,38 €';
$snippet->celkom = '202,38 €';
$snippet->splatnost = '9. 8. 2015';
