<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/multiform_cz/product_snippet_cache27245.latte

class Template1d15884017389772d52015b9e2c7d44e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4a61d8a847', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '100 000 kč', 'pocet_splatok' => '60', 'splatka' => '2 299 Kč', 'rpmn' => '14,1 %', 'urok' => '13,22 %', 'poplatok' => '-', 'celkom' => '137 940 Kč', 'celkova_uspora' => '', 'splatnost' => '6. 7. 2020',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '150 000 Kč', 'pocet_splatok' => '12', 'splatka' => '14 836 Kč', 'rpmn' => '38,56 %', 'urok' => '33,06 %', 'poplatok' => '-', 'celkom' => '118 800 kč', 'celkova_uspora' => '', 'splatnost' => '6. 7. 2016',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '150 000 kč', 'pocet_splatok' => '48', 'splatka' => '5 651 Kč', 'rpmn' => '38,25 %', 'urok' => '32,83 %', 'poplatok' => '- ', 'celkom' => '271 248 Kč', 'celkova_uspora' => '', 'splatnost' => '6. 7. 2019',), 
);
