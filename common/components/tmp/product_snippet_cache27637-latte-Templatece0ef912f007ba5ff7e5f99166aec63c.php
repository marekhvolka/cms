<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/prima_banka_sporiaci_ucet/product_snippet_cache27637.latte

class Templatece0ef912f007ba5ff7e5f99166aec63c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9d7af1b218', 'html')
;
//
// main template
//
