<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/sberbank_ferovapozicka/product_snippet_cache27567.latte

class Templatede29f60d2eff24113cabe928ca0e4faa extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('57320416ab', 'html')
;
//
// main template
//
