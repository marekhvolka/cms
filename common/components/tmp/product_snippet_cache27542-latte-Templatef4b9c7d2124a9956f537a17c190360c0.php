<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/konsolidace_pujcek_home_credit/product_snippet_cache27542.latte

class Templatef4b9c7d2124a9956f537a17c190360c0 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7dae7c5871', 'html')
;
//
// main template
//
...
'1' => (object) array(
'ponuka' => 'Nová nabídka', 'vyska' => '180 000 Kč   ', 'pocet_splatok' => '84', 'splatka' => '3 178 Kč', 'rpmn' => '', 'urok' => '', 'poplatok' => '', 'celkom' => '266 952 Kč', 'celkova_uspora' => '69 191 Kč', 'splatnost' => '',), 
);
