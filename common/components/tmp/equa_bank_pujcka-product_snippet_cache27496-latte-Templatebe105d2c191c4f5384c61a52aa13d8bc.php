<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/equa_bank_pujcka/product_snippet_cache27496.latte

class Templatebe105d2c191c4f5384c61a52aa13d8bc extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3edf4e22cb', 'html')
;
//
// main template
//
...
$snippet->vyska = '300 000 Kč';
$snippet->pocet_splatok = '30';
$snippet->splatka = '11 330 Kč';
$snippet->rpmn = '10,37 %';
$snippet->urok = '9,90 %';
$snippet->poplatok = '0 Kč';
$snippet->celkom = '339 900 Kč';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 2. 9. 2015.';
