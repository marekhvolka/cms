<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zuno_pujcka/product_snippet_cache27585.latte

class Templatec836b43417d79b3808363d34242054c6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8210505601', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 27. 11. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '24', 'splatka' => '4 610 Kč', 'urok' => '9,9 %', 'poplatok' => '0 Kč', 'rpmn' => '', 'celkom' => '110 640 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '250 000 Kč', 'pocet_splatok' => '42', 'splatka' => '6 717 Kč', 'urok' => '6,9 %', 'poplatok' => '0 Kč', 'rpmn' => '', 'celkom' => '282 114 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '72', 'splatka' => '8 501 Kč ', 'urok' => '6,9 %', 'poplatok' => '0 Kč', 'rpmn' => '', 'celkom' => '612 072 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
