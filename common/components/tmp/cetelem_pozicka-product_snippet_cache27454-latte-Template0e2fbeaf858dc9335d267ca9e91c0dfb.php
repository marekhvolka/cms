<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/cetelem_pozicka/product_snippet_cache27454.latte

class Template0e2fbeaf858dc9335d267ca9e91c0dfb extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c7b26ea9cd', 'html')
;
//
// main template
//
...
$snippet->splatka = '135,43 €';
$snippet->rpmn = '16,18 %';
$snippet->urok = '15,09 %';
$snippet->poplatok = '-';
$snippet->celkom = '11 376,12 €';
$snippet->splatnost = '14. 7. 2022';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 14. 7. 2015.';
