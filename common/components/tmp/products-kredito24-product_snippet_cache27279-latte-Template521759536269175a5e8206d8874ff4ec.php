<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/kredito24/product_snippet_cache27279.latte

class Template521759536269175a5e8206d8874ff4ec extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('d1ac386c37', 'html')
;
//
// main template
//
...
$snippet->vyska = '1 000 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '30';
$snippet->rpmn = '-';
$snippet->urok = '-';
$snippet->poplatok = '300 Kč';
$snippet->celkom = '1 300 Kč';
$snippet->splatnost = '22. 8. 2015';
