<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/home_credit_pujcka/product_snippet_cache27516.latte

class Templatee1b1b3619b6e07108b9bd20bc4b8eca5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ad1c328b9b', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '60', 'splatka' => '2 299 Kč', 'rpmn' => '11,1 %', 'urok' => '10,55 %', 'poplatok' => '-', 'celkom' => '128 455 Kč **', 'celkova_uspora' => '', 'splatnost' => '15. 8. 2020',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '120 000 Kč', 'pocet_splatok' => '72', 'splatka' => '2 636 Kč', 'rpmn' => '14,0 %', 'urok' => '13,08 %', 'poplatok' => '-', 'celkom' => '172 344 Kč **', 'celkova_uspora' => '', 'splatnost' => '15. 8. 2021',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '180 000 Kč', 'pocet_splatok' => '72', 'splatka' => '3 699 Kč', 'rpmn' => '11,6 %', 'urok' => '10,94 %', 'poplatok' => '-', 'celkom' => '244 746 Kč **', 'celkova_uspora' => '', 'splatnost' => '15. 8. 2021',), 
);
