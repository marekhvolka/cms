<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/airbank_pujcka/product_snippet_cache27339.latte

class Template60c66328329190481700bd2885c8b7c4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f883b2c245', 'html')
;
//
// main template
//
...
$snippet->vyska = '200 000 Kč';
$snippet->pocet_splatok = '57';
$snippet->splatka = '4 898 Kč';
$snippet->rpmn = '10,37 %';
$snippet->urok = '9,9 %';
$snippet->poplatok = '0 Kč';
$snippet->celkom = '244 121 Kč';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 16. 7. 2015 za podmínky včasného splácení.';
