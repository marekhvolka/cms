<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/ceska_sporitelna_pujcka/product_snippet_cache27376.latte

class Templateecd0e6679bcfb080aaa6dbd573f46dc4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('330b7bd81c', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '140 000 Kč', 'pocet_splatok' => '24', 'splatka' => '6 869 Kč', 'rpmn' => '19,49 %', 'urok' => '16,6 %', 'poplatok' => '1 000 Kč', 'celkom' => '166 243 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '24', 'splatka' => '23 713 Kč', 'rpmn' => '15,30 %', 'urok' => '13,1 %', 'poplatok' => '1 000 Kč', 'celkom' => '574 096 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '30 000 Kč', 'pocet_splatok' => '36', 'splatka' => '1 110 Kč', 'rpmn' => '23,07 %', 'urok' => '19,9 %', 'poplatok' => '1 000 Kč', 'celkom' => '40 222 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
