<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/multiform_sk/product_snippet_cache27267.latte

class Template9455ee450f527e847f00910bac6bf9c3 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6272de6393', 'html')
;
//
// main template
//
...
'0' => (object) array(
'text' => 'fyzická osoba s minimálnym vekom 18 rokov',), 
'1' => (object) array(
'text' => 'trvalý pobyt na území Slovenska',), 
'2' => (object) array(
'text' => 'preukázanie dvoch dokladov totožnosti',), 
'3' => (object) array(
'text' => 'trvalý zdroj príjmu',), 
)
?>
<div class="vyhody">
  <a id="vyhody"></a>
