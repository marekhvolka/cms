<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zuno_refinancovani/product_snippet_cache27551.latte

class Template5b69864538b2ca242bfe0cfe4c90d31c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('fbd859a2f6', 'html')
;
//
// main template
//
...
$snippet->platnost = 'Uvedené údaje jsou čerpány z web stránky poskytovatele ke dni 13. 11. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => 'Původní úvěr', 'vyska' => '180 000 Kč', 'pocet_splatok' => '84', 'splatka' => '3 299 Kč', 'urok' => '13,27 %', 'poplatok' => '', 'rpmn' => '14,2 %', 'celkom' => '277 116 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => 'Nová nabídka', 'vyska' => '174 912 Kč', 'pocet_splatok' => '72', 'splatka' => '3231,6 Kč', 'urok' => '', 'poplatok' => '', 'rpmn' => '', 'celkom' => '232 675,2 Kč', 'celkova_uspora' => '44 441 Kč', 'splatnost' => '',), 
);
