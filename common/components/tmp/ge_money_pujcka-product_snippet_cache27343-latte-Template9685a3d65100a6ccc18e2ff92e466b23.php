<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/ge_money_pujcka/product_snippet_cache27343.latte

class Template9685a3d65100a6ccc18e2ff92e466b23 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('97cf70fbea', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 3. 8. 2015. <br>**Platí u online žádosti, při sjednání na pobočce poplatek 1 295 Kč.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '50 000 Kč', 'pocet_splatok' => '24', 'splatka' => '2 298,03 Kč', 'rpmn' => '12,9 %', 'urok' => '9,6 %', 'poplatok' => '0 Kč **', 'celkom' => '55 152,72 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '50', 'splatka' => '2 434,48 Kč', 'rpmn' => '10,7 %', 'urok' => '9,6 %', 'poplatok' => '0 Kč **', 'celkom' => '121 724 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '200 000 Kč', 'pocet_splatok' => '108', 'splatka' => '2 841,91 Kč', 'rpmn' => '10,2 %', 'urok' => '9,6 %', 'poplatok' => '0 Kč **', 'celkom' => '306 926,28 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
