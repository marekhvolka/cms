<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/vitacredit_pujcka/product_snippet_cache27402.latte

class Templatee0e2c8678f8c9e29176589aa5f0312d6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3ee5962de1', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '50 000 kč', 'pocet_splatok' => '12', 'splatka' => '4 393 Kč', 'rpmn' => '29,8 %', 'urok' => '9,9 %', 'poplatok' => '4 100 Kč', 'celkom' => '56 816 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '84', 'splatka' => '8 275 Kč', 'rpmn' => '11,5 %', 'urok' => ' 9,9 %', 'poplatok' => '16 100 Kč', 'celkom' => '711 200 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '1 880 000 Kč', 'pocet_splatok' => '180', 'splatka' => '20 088 Kč', 'rpmn' => '10,6 %', 'urok' => ' 9,9 %', 'poplatok' => ' 22 100 Kč', 'celkom' => '3 637 940 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
