<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/mpujcka/product_snippet_cache27355.latte

class Template2673da3017f9194e063c55df2e014518 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b7e61d60b5', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '50 000 Kč', 'pocet_splatok' => '60', 'splatka' => '1 060 Kč', 'rpmn' => '10,36 %', 'urok' => '9,9 %', 'poplatok' => '0 Kč', 'celkom' => '63 594 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '36', 'splatka' => '3 222 Kč', 'rpmn' => '10,36 %', 'urok' => '9,9 %', 'poplatok' => '0 Kč', 'celkom' => '115 993 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '72', 'splatka' => '9 238 Kč', 'rpmn' => '10,36 %', 'urok' => '9,9 %', 'poplatok' => '0 Kč', 'celkom' => '665 116 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
