<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/prima_banka_pozicka/product_snippet_cache27581.latte

class Template83cc16557e604e52922a6788cad43b08 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e692c04403', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera k dňu 26. 11. 2015.  <br> * Úver nezahŕňa poistenie.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '2 000 €', 'pocet_splatok' => '60', 'splatka' => '51,04 €', 'urok' => '17,90 %', 'poplatok' => '60 €', 'rpmn' => '21,44 %', 'celkom' => '3 123 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '5 000 €', 'pocet_splatok' => '48', 'splatka' => '137,04 €', 'urok' => '13,90 %	', 'poplatok' => '150 €', 'rpmn' => '16,96 %	', 'celkom' => '6 728 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '10 000 €', 'pocet_splatok' => '108', 'splatka' => '141,14 €	', 'urok' => '9,90 %', 'poplatok' => '300 €', 'rpmn' => '11,39 %', 'celkom' => '15 544 €', 'celkova_uspora' => '', 'splatnost' => '',), 
);
...
$snippet->poplatok_label = 'Poplatok za poskytnutie';
