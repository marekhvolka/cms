<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/mikro_multiform_cz/product_snippet_cache27253.latte

class Templatebd663172479ed209f1d9a2021dbcd645 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f22f3aa40c', 'html')
;
//
// main template
//
