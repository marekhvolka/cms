<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/acema_pujcka/product_snippet_cache27364.latte

class Templated6b6e025ada62a396bc56cfbdfd1d381 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('d0f6e37595', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '150 000 Kč', 'pocet_splatok' => '60', 'splatka' => '4 833 Kč', 'rpmn' => '34,20 %', 'urok' => '25.92%', 'poplatok' => '-', 'celkom' => '289 980 Kč', 'celkova_uspora' => '', 'splatnost' => '2. 7. 2020',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '300 000 Kč', 'pocet_splatok' => '96', 'splatka' => '7 785 Kč', 'rpmn' => '31,43 %', 'urok' => '25.92%', 'poplatok' => '-', 'celkom' => '747 360 Kč', 'celkova_uspora' => '', 'splatnost' => '2. 7. 2023',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '120', 'splatka' => '12 050 Kč', 'rpmn' => '30,47', 'urok' => '25.92%', 'poplatok' => '-', 'celkom' => '1 446 000 Kč', 'celkova_uspora' => '', 'splatnost' => '2. 7. 2025',), 
);
