<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/pujcka7/product_snippet_cache27387.latte

class Template1cfc60a282ea57fca93ddbc1d23e3611 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('42e3964466', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 23. 7. 2015';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '3 000 Kč', 'pocet_splatok' => '1', 'splatka' => '14 ', 'rpmn' => '5341.1%', 'urok' => '- ', 'poplatok' => '497 Kč', 'celkom' => '3 497 Kč', 'celkova_uspora' => '', 'splatnost' => '6. 8. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '10 000 Kč', 'pocet_splatok' => '1', 'splatka' => '7', 'rpmn' => '11 093.3 %', 'urok' => '- ', 'poplatok' => '947 Kč', 'celkom' => '10 947 Kč', 'celkova_uspora' => '', 'splatnost' => '30. 7. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '14 000 Kč', 'pocet_splatok' => '1', 'splatka' => '28 ', 'rpmn' => '1 975.2 %', 'urok' => '- ', 'poplatok' => '3 667 Kč', 'celkom' => '17 667 Kč', 'celkova_uspora' => '', 'splatnost' => '20. 8. 2015',), 
);
$snippet->vyska_label = '' . $slovnik->vyska_pozicky . '';
$snippet->pocet_splatok_label = '' . $slovnik->pocet_splatok . '';
$snippet->splatka_label = 'Počet dní splacení';
