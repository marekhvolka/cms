<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/creditone_sk/product_snippet_cache27308.latte

class Templatef079aea7b78142e992353e0f7e061259 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1cb724aa9f', 'html')
;
//
// main template
//
...
/* Snippet values */
/* Var values  */
$snippet->nadpis = 'Tabuľka splátok pôžičky CreditOne';
$snippet->platnost = '* Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 25. 7. 2015. <br>** Platí len pre nových klientov.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '30 € **', 'pocet_splatok' => '1', 'splatka' => '10 dní', 'rpmn' => '0 %', 'urok' => '0 %', 'poplatok' => '0 €', 'celkom' => '30 €', 'celkova_uspora' => '', 'splatnost' => '4. 8. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '100 € **', 'pocet_splatok' => '1', 'splatka' => '15 dní', 'rpmn' => '0 %', 'urok' => '0 %', 'poplatok' => '0 €', 'celkom' => '100 €', 'celkova_uspora' => '', 'splatnost' => '9. 8. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '180 € **', 'pocet_splatok' => '1', 'splatka' => '30 dní', 'rpmn' => '0 %', 'urok' => '0 %', 'poplatok' => '0 €', 'celkom' => '180 €', 'celkova_uspora' => '', 'splatnost' => '24. 8. 2015',), 
'3' => (object) array(
'ponuka' => '', 'vyska' => '500 €', 'pocet_splatok' => '1', 'splatka' => '10 dní', 'rpmn' => '29 %', 'urok' => '26 %', 'poplatok' => '3,5 €', 'celkom' => '503,5 €', 'celkova_uspora' => '', 'splatnost' => '9. 8. 2015',), 
);
