<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/japonska_pujcka/product_snippet_cache27422.latte

class Template32c67d692c8506ddfbc05a9b6db31bb7 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('d4a98314ee', 'html')
;
//
// main template
//
...
$snippet->rpmn = '49,04 %';
$snippet->urok = '0 %';
$snippet->poplatok = '100 Kč';
$snippet->celkom = '3 100 Kč';
$snippet->splatnost = '26. 8. 2015';
