<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/csob_pujcka/product_snippet_cache27655.latte

class Template81f269d7dd9aec0a023860d2aa4fe907 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b909abb261', 'html')
;
//
// main template
//
...
$snippet->splatka = '2 532 Kč';
$snippet->urok = '9,9 % ';
$snippet->poplatok = '6 Kč';
$snippet->rpmn = '10,5 %';
$snippet->celkom = '121 824 Kč';
$snippet->platnost = '* Reprezentativní příklad je čerpán z oficiální stránky poskytovatele k datu: 12. 2. 2016.';
