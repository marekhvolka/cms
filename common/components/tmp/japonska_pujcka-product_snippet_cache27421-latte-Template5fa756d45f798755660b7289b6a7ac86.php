<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/japonska_pujcka/product_snippet_cache27421.latte

class Template5fa756d45f798755660b7289b6a7ac86 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0982d1d322', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 27. 7. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '3 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '49,04 %', 'urok' => '0 %', 'poplatok' => '100 Kč', 'celkom' => '3 100 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
