<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/everyday_pujcka/product_snippet_cache27358.latte

class Template2c30293baafa953a160e30b51e91eb3d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('91cd9d7455', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 20. 7. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '500 Kč', 'pocet_splatok' => '1', 'splatka' => 'do následujícího měsíce', 'rpmn' => '247,58 %', 'urok' => '-', 'poplatok' => '100 Kč', 'celkom' => '600 Kč', 'celkova_uspora' => '', 'splatnost' => '31. 8. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '1 500 Kč', 'pocet_splatok' => '1', 'splatka' => 'do následujícího měsíce', 'rpmn' => '247,58 %', 'urok' => '-', 'poplatok' => '300 Kč', 'celkom' => '1 800 Kč', 'celkova_uspora' => '', 'splatnost' => '31. 8. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '5 000 Kč', 'pocet_splatok' => '1', 'splatka' => 'do následujícího měsíce', 'rpmn' => '247,58 %', 'urok' => '-', 'poplatok' => '1 000 Kč', 'celkom' => '6 000 Kč', 'celkova_uspora' => '', 'splatnost' => '31. 8. 2015',), 
);
