<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/aasa_pujcka/product_snippet_cache27389.latte

class Template536c97fc72bc55604b2e51141601bc4f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('fd9fbb5f3d', 'html')
;
//
// main template
//
...
$snippet->splatka = '2 223 Kč';
$snippet->rpmn = '225 Kč / měsíc';
$snippet->urok = '19 %';
$snippet->poplatok = '1 900 Kč';
$snippet->celkom = '26 670 Kč';
