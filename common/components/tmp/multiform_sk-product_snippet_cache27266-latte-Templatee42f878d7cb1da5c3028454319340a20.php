<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/multiform_sk/product_snippet_cache27266.latte

class Templatee42f878d7cb1da5c3028454319340a20 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4d4550754f', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 1. 10. 2015.';
