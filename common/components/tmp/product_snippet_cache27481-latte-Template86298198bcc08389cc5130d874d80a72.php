<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/unicredit_presto_pozicka/product_snippet_cache27481.latte

class Template86298198bcc08389cc5130d874d80a72 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('80924eae07', 'html')
;
//
// main template
//
...
/* Snippet values */
/* Var values  */
$snippet->nadpis = 'UniCredit Bank pôžička - tabuľka splátok';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera k dňu 14. 7. 2015';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '1 000 €', 'pocet_splatok' => '36', 'splatka' => '34,79 €', 'rpmn' => '19,78 %', 'urok' => '7,90 %', 'poplatok' => '', 'celkom' => '1 253,00 €', 'celkova_uspora' => '', 'splatnost' => '20. 2. 2018',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '5 000 €', 'pocet_splatok' => '60', 'splatka' => '114,29 €', 'rpmn' => '14,54 %', 'urok' => '7,90 %', 'poplatok' => '', 'celkom' => '6 857,00 €', 'celkova_uspora' => '', 'splatnost' => '20. 2. 2020',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '7 500 €', 'pocet_splatok' => '72', 'splatka' => '151,33 €', 'rpmn' => '14,46 %', 'urok' => '7,90 %', 'poplatok' => '', 'celkom' => '10 896,00 €', 'celkova_uspora' => '', 'splatnost' => '20. 2. 2021',), 
);
