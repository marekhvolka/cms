<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/vata_online/product_snippet_cache27408.latte

class Templatec12acb0600e34977334afc78a37b9c06 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0b25b30224', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 28. 9. 2015. ';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '500 Kč', 'pocet_splatok' => '1', 'splatka' => '10', 'rpmn' => '3142 %', 'urok' => '1 % denně', 'poplatok' => '50 Kč', 'celkom' => '550 Kč', 'celkova_uspora' => '', 'splatnost' => '8.10. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '2 000 Kč', 'pocet_splatok' => '1', 'splatka' => '20', 'rpmn' => '2686 %', 'urok' => '1 % denně', 'poplatok' => '400 Kč', 'celkom' => '2 400 Kč', 'celkova_uspora' => '', 'splatnost' => '18.10. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '4 500 Kč', 'pocet_splatok' => '1', 'splatka' => '20', 'rpmn' => '2 686 %', 'urok' => '1 % denně', 'poplatok' => '900 Kč', 'celkom' => '5 400 Kč', 'celkova_uspora' => '', 'splatnost' => '18.10. 2015',), 
);
...
$snippet->poplatok_label = 'Poplatek za půjčku';
