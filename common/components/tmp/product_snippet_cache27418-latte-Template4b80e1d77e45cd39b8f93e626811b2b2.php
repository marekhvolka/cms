<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/unicredit_cz_presto/product_snippet_cache27418.latte

class Template4b80e1d77e45cd39b8f93e626811b2b2 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('81a6294c8e', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 25. 7. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '30 000 Kč', 'pocet_splatok' => '12', 'splatka' => '2 776 Kč', 'rpmn' => '15,54 %', 'urok' => '10,40 %', 'poplatok' => '1 500 Kč ', 'celkom' => '33 581 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '24', 'splatka' => '4 726 Kč', 'rpmn' => '15,54 %', 'urok' => '10,90 %', 'poplatok' => '1 500 Kč ', 'celkom' => '114 334 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '12', 'splatka' => '44 184 Kč', 'rpmn' => '15,54 %', 'urok' => '10,40 %', 'poplatok' => '1 500 Kč ', 'celkom' => '534 494 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
