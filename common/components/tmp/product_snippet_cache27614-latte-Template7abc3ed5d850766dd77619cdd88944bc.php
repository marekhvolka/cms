<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/provident_pujcka_cz/product_snippet_cache27614.latte

class Template7abc3ed5d850766dd77619cdd88944bc extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('dd6484d63a', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 18. 9. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '18 000 Kč', 'pocet_splatok' => '10', 'splatka' => '2 288 Kč', 'rpmn' => '71,95 %', 'urok' => '21,31 %', 'poplatok' => '3 002 Kč', 'celkom' => '22 879 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '40 000 Kč', 'pocet_splatok' => '15', 'splatka' => '3 566 Kč', 'rpmn' => '57,86 %', 'urok' => '18,15 %', 'poplatok' => '8 221 Kč', 'celkom' => '53 488 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '60 000 Kč', 'pocet_splatok' => '22', 'splatka' => '4 006 Kč', 'rpmn' => '53,40 %', 'urok' => '20,08 %', 'poplatok' => '15 144 Kč', 'celkom' => '88 113 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
