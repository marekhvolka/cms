<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/otp_pozicka/product_snippet_cache27559.latte

class Template4731ce883c1da3889698fa0e382431af extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a950741076', 'html')
;
//
// main template
//
...
$snippet->platnost = '* Uvedené údaje sú čerpané z oficiálnej stránky partnera k dňu 17. 11. 2015 <br> ** Zahŕňa aj poplatok za poistenie úveru. <br> *** Nezahŕňa výšku benefitu v prípade bezproblémového splácania.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '3 000 €', 'pocet_splatok' => '60', 'splatka' => '70,48 €', 'urok' => '7,70 %', 'poplatok' => '60 €', 'rpmn' => '16,51 %', 'celkom' => '4 290,76 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '5 000 €', 'pocet_splatok' => '72', 'splatka' => '99,58 €', 'urok' => '7,70 %', 'poplatok' => '60 €', 'rpmn' => '15,14 %', 'celkom' => '7 453,01 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '8 000 €', 'pocet_splatok' => '84', 'splatka' => '144,23 €', 'urok' => '7,70 %', 'poplatok' => '60 €', 'rpmn' => '14,94 %', 'celkom' => '12 594,23 €', 'celkova_uspora' => '', 'splatnost' => '',), 
);
