<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/repujcka_od equa bank_konsolidace/product_snippet_cache27606.latte

class Template3880993b1611068df9c30fc5a700f2df extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('fd728c2957', 'html')
;
//
// main template
//
...
'1' => (object) array(
'ponuka' => 'Nová nabídka', 'vyska' => '180 000 Kč', 'pocet_splatok' => '84', 'splatka' => '2 369 Kč', 'urok' => '9,90 %', 'poplatok' => '', 'rpmn' => '10,36 %', 'celkom' => '284 280 Kč', 'celkova_uspora' => '51 863 Kč', 'splatnost' => '',), 
);
