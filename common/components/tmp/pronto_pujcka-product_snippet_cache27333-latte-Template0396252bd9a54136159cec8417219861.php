<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/pronto_pujcka/product_snippet_cache27333.latte

class Template0396252bd9a54136159cec8417219861 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f5a2ca7d46', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '10 000 Kč', 'pocet_splatok' => '24', 'splatka' => '791 Kč', 'rpmn' => '98.83 %', 'urok' => '-', 'poplatok' => '-', 'celkom' => '18 984 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '20 000 Kč', 'pocet_splatok' => '24', 'splatka' => '1 582 Kč', 'rpmn' => '98.83 %', 'urok' => '-', 'poplatok' => '-', 'celkom' => '37 968 kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '50 000 kč', 'pocet_splatok' => '36', 'splatka' => '3 388 Kč', 'rpmn' => '98.96 %', 'urok' => '-', 'poplatok' => '-', 'celkom' => '94 968 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
