<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/netcredit_pujcka/product_snippet_cache27399.latte

class Templatebce427a5ce6af3fb52f4d51322286800 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('237385080b', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '1 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '0 %', 'urok' => '0 %', 'poplatok' => '0 Kč', 'celkom' => '1 000 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '4 000 Kč', 'pocet_splatok' => '1', 'splatka' => '20', 'rpmn' => '0 %', 'urok' => '0 %', 'poplatok' => '0 Kč', 'celkom' => '4 000 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '6 000 Kč', 'pocet_splatok' => '1', 'splatka' => '10', 'rpmn' => '18.47 %', 'urok' => '1 108 Kč', 'poplatok' => '0 Kč', 'celkom' => '7 108 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
