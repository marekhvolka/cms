<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/netcredit_pujcka/product_snippet_cache27400.latte

class Template792fe75a77ed4dcd654ae2afcf4b6550 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2afd6dfc97', 'html')
;
//
// main template
//
...
$snippet->vyska = '4 000 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '20';
$snippet->rpmn = '-';
$snippet->urok = '-';
$snippet->poplatok = '-';
$snippet->celkom = '4 000 Kč';
$snippet->splatnost = '3. 8. 2015';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni: 14. 7. 2015.';
