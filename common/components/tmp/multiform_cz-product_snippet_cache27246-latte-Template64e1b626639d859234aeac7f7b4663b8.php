<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/multiform_cz/product_snippet_cache27246.latte

class Template64e1b626639d859234aeac7f7b4663b8 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('5e917182ed', 'html')
;
//
// main template
//
