<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/provident_pujcka_cz/product_snippet_cache27613.latte

class Template530b9e2c53d3354a00fd59c08d64ae48 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('36ec71cc93', 'html')
;
//
// main template
//
...
$snippet->vyska = '60 000 Kč';
$snippet->pocet_splatok = '22';
$snippet->splatka = '4 006 Kč';
$snippet->rpmn = '53,40 %';
$snippet->urok = '20,08 %';
$snippet->poplatok = '15 142 Kč';
$snippet->celkom = '88 113 Kč';
