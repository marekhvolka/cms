<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zaplo_cz/product_snippet_cache27311.latte

class Templatea71853b3be136edd6519798cc68e0134 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9b0e55ffc1', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Platí pouze při půjčka u nového klienta. <br> **Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 30. 9. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '5 000 Kč *', 'pocet_splatok' => '1', 'splatka' => '15', 'rpmn' => '0 % ', 'urok' => '0 %', 'poplatok' => '0 Kč', 'celkom' => '5 000 Kč', 'celkova_uspora' => '', 'splatnost' => '15. 10. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '5 000 Kč', 'pocet_splatok' => '1', 'splatka' => '15', 'rpmn' => '4 462,4 %', 'urok' => '413,67 %', 'poplatok' => '850 Kč', 'celkom' => '5 850 Kč', 'celkova_uspora' => '', 'splatnost' => '15. 10. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '12 000 Kč', 'pocet_splatok' => '1', 'splatka' => '20', 'rpmn' => '2 291,8 %', 'urok' => '346,75 %', 'poplatok' => '2 280 Kč', 'celkom' => '14 280 Kč', 'celkova_uspora' => '', 'splatnost' => '20. 10. 2015',), 
);
