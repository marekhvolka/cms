<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/portals/hyperfinancie.sk/pages/page87/blocks/product_snippet_cache27707.latte

class Templatede33673b06f051aec1df3ae06380fa09 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0d3913b345', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 28. 9. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '100 €', 'pocet_splatok' => '3', 'splatka' => '35,83 €', 'rpmn' => '54,69 %', 'urok' => '22,01 %', 'poplatok' => '3,78 €', 'celkom' => '107,49 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '1 000 €', 'pocet_splatok' => '15', 'splatka' => '88,03 €', 'rpmn' => '54,57 %', 'urok' => '21,68 %', 'poplatok' => '163,72 €', 'celkom' => '1 320,43 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '2 000 €', 'pocet_splatok' => '22', 'splatka' => '135,90 €', 'rpmn' => '56,64 %', 'urok' => '21,61 %', 'poplatok' => '521,91 €', 'celkom' => '2 989,71 €', 'celkova_uspora' => '', 'splatnost' => '',), 
);
