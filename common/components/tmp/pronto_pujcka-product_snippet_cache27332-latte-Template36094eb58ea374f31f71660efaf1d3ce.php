<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/pronto_pujcka/product_snippet_cache27332.latte

class Template36094eb58ea374f31f71660efaf1d3ce extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b4375d7d7a', 'html')
;
//
// main template
//
...
$snippet->vyska = '10 000 Kč';
$snippet->pocet_splatok = '24';
$snippet->splatka = '791 Kč';
$snippet->rpmn = '98,83 % ';
$snippet->urok = '-';
$snippet->poplatok = '-';
$snippet->celkom = '18 984 Kč';
