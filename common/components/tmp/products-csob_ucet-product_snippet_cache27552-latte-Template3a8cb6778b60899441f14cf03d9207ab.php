<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/csob_ucet/product_snippet_cache27552.latte

class Template3a8cb6778b60899441f14cf03d9207ab extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('bfedf8c2b4', 'html')
;
//
// main template
//
