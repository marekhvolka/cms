<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/zuno_sporenie_plus/product_snippet_cache27633.latte

class Templatef02b6f109a75c345eb8817b03389da0b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('118d77c6ac', 'html')
;
//
// main template
//
