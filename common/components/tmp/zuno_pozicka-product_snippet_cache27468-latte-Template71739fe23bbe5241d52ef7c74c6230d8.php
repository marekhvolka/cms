<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/zuno_pozicka/product_snippet_cache27468.latte

class Template71739fe23bbe5241d52ef7c74c6230d8 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ccd9205583', 'html')
;
//
// main template
//
