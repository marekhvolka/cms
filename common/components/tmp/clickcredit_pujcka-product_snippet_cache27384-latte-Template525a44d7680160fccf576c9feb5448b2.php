<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/clickcredit_pujcka/product_snippet_cache27384.latte

class Template525a44d7680160fccf576c9feb5448b2 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a8bf51cccc', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 17. 7. 2015';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '1 500 Kč', 'pocet_splatok' => '1', 'splatka' => '30 dní', 'rpmn' => '48 %', 'urok' => '-', 'poplatok' => '50 Kč', 'celkom' => '1 550 Kč', 'celkova_uspora' => '', 'splatnost' => '16. 8. 2015 ',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '2 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30 dní', 'rpmn' => '48 %', 'urok' => '-', 'poplatok' => '66 Kč', 'celkom' => '2 066 Kč', 'celkova_uspora' => '', 'splatnost' => '16. 8. 2015 ',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '3 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30 dní', 'rpmn' => '48 %', 'urok' => '-', 'poplatok' => '99 Kč', 'celkom' => '3 099 Kč ', 'celkova_uspora' => '', 'splatnost' => '16. 8. 2015 ',), 
);
$snippet->vyska_label = '' . $slovnik->vyska_pozicky . '';
$snippet->pocet_splatok_label = '' . $slovnik->pocet_splatok . '';
$snippet->splatka_label = 'Doba splatnosti';
