<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/sberbank_pujcka/product_snippet_cache27575.latte

class Template4ebd4b946ff061a1cd50b8dbe89d0ff3 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('23fee5dd60', 'html')
;
//
// main template
//
...
'2' => (object) array(
'text' => 'úplné bankovní výpisy z účtu za poslední 3 měsíce',), 
)
?>
<div class="vyhody">
  <a id="vyhody"></a>
