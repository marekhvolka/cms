<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/otp_pozicka/product_snippet_cache27560.latte

class Template9f0dc8d7d1bb4ad48dfed2bbf6d081b6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('fcbd9ad667', 'html')
;
//
// main template
//
...
$snippet->splatka = '70,48 €';
$snippet->urok = '7,70 %';
$snippet->poplatok = '60 €';
$snippet->rpmn = '16,51 %';
$snippet->celkom = '4 290,76 €';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 17. 11. 2015. <br>**Zahŕňa aj poplatok za poistenie úveru. <br>***Nezahŕňa výšku benefitu v prípade bezproblémového splácania.';
