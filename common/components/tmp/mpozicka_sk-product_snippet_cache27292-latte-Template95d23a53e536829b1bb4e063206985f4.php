<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/mpozicka_sk/product_snippet_cache27292.latte

class Template95d23a53e536829b1bb4e063206985f4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('0d2407285c', 'html')
;
//
// main template
//
...
/* Snippet values */
/* Var values  */
$snippet->nadpis = 'Pôžička od mBank - tabuľka splátok';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera k dňu 14. 7. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '1 000 €', 'pocet_splatok' => '36', 'splatka' => '32 €', 'rpmn' => '10,36 %', 'urok' => '9,9 %', 'poplatok' => '0 € ', 'celkom' => '1 160 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '2 000 €', 'pocet_splatok' => '60', 'splatka' => '42 €', 'rpmn' => '10,36 %', 'urok' => '9,9 %', 'poplatok' => '0 € ', 'celkom' => '2 544 €', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '6 000 €', 'pocet_splatok' => '72', 'splatka' => '111 €', 'rpmn' => '10,36 %', 'urok' => '9,9 %', 'poplatok' => '0 € ', 'celkom' => '7 981 €', 'celkova_uspora' => '', 'splatnost' => '',), 
);
