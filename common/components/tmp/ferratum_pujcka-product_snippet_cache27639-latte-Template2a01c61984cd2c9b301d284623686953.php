<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/ferratum_pujcka/product_snippet_cache27639.latte

class Template2a01c61984cd2c9b301d284623686953 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('571925a3c2', 'html')
;
//
// main template
//
...
$snippet->rpmn = '3 113 %';
$snippet->urok = '401, 50 %';
$snippet->poplatok = '660 Kč';
$snippet->celkom = '2 660 Kč';
