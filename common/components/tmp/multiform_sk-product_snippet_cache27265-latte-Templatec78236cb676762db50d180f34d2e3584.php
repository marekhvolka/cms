<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/multiform_sk/product_snippet_cache27265.latte

class Templatec78236cb676762db50d180f34d2e3584 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('777a929c39', 'html')
;
//
// main template
//
...
$snippet->splatka = '88,03 €';
$snippet->rpmn = '54,57 %';
$snippet->urok = '21,68 %';
$snippet->poplatok = '163,72 €';
$snippet->celkom = '1 320,43 €';
