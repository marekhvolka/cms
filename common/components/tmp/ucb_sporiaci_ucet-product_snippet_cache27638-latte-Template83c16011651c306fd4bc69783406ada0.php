<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/ucb_sporiaci_ucet/product_snippet_cache27638.latte

class Template83c16011651c306fd4bc69783406ada0 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('773855836b', 'html')
;
//
// main template
//
