<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/proficredit_pozicka/product_snippet_cache27449.latte

class Template5052e7edfc224bf1c4d2abb33a2239c5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a9ff6c6303', 'html')
;
//
// main template
//
