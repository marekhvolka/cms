<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/home_credit_pujcka/product_snippet_cache27517.latte

class Template7fc7736d010b13930958d83319e1c54b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('df96720778', 'html')
;
//
// main template
//
...
'3' => (object) array(
'text' => 'údaje o zaměstnavateli (název, IČO, adresa a telefon)',), 
'4' => (object) array(
'text' => 'podnikatelé budou dodávat údaje o svém podnikání (název, IČO, adresa a telefon)',), 
)
?>
<div class="vyhody">
  <a id="vyhody"></a>
