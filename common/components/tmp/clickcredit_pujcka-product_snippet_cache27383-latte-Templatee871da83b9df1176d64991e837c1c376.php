<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/clickcredit_pujcka/product_snippet_cache27383.latte

class Templatee871da83b9df1176d64991e837c1c376 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('d34d4fdd0b', 'html')
;
//
// main template
//
...
$snippet->rpmn = '48 %';
$snippet->urok = '0 %';
$snippet->poplatok = '99 Kč';
$snippet->celkom = '3 099 Kč';
$snippet->splatnost = '31. 7. 2015';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 1. 7. 2015';
