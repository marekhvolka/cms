<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/everyday_pujcka/product_snippet_cache27357.latte

class Template99762edbc8fde687ef607c8e717a6b34 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('42ed646c24', 'html')
;
//
// main template
//
...
$snippet->splatka = 'konec následujícího měsíce';
$snippet->rpmn = '247,58 %';
$snippet->urok = '-';
$snippet->poplatok = '400 Kč';
$snippet->celkom = '2 400 Kč';
$snippet->splatnost = '31. 8. 2015';
