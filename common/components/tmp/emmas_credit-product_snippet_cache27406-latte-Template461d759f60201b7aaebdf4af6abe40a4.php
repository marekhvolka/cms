<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/emmas_credit/product_snippet_cache27406.latte

class Template461d759f60201b7aaebdf4af6abe40a4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('7ab76f521c', 'html')
;
//
// main template
//
...
$snippet->vyska = '500 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '22';
$snippet->rpmn = '-';
$snippet->urok = '110 Kč';
$snippet->poplatok = '-';
$snippet->celkom = '610 Kč';
$snippet->splatnost = '20. 8. 2015';
