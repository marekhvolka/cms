<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/cofidis_pujcka/product_snippet_cache27411.latte

class Template581d548d03842bb84d15b2f95ea757c7 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('304eaa70a3', 'html')
;
//
// main template
//
...
$snippet->vyska = '120 000 Kč';
$snippet->pocet_splatok = '84';
$snippet->splatka = '1 793 Kč';
$snippet->rpmn = '6.9 %';
$snippet->urok = '6,9 %';
$snippet->poplatok = '0 Kč';
$snippet->celkom = '150 612 Kč';
