<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zaimo_cz/product_snippet_cache27305.latte

class Templateee66371b8b5900ac4b97d50209c76185 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f7bddaeca9', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '25 000 Kč', 'pocet_splatok' => '12', 'splatka' => '3 317,38 Kč', 'rpmn' => '151,82 %', 'urok' => '59,23 %', 'poplatok' => '14 808,56 Kč', 'celkom' => '39 808,56 Kč', 'celkova_uspora' => '', 'splatnost' => '7. 7. 2016',), 
);
