<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zaplo_cz/product_snippet_cache27310.latte

class Templatef9af18ecf88143166c29e58957282a88 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('980594901a', 'html')
;
//
// main template
//
...
$snippet->vyska = '12 000 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '20';
$snippet->rpmn = '2 291,8 %';
$snippet->urok = '346,75 %';
$snippet->poplatok = '2 280 Kč';
$snippet->celkom = '14 280 Kč';
$snippet->splatnost = '20. 10. 2015';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 30. 9. 2015';
$snippet->vyska_label = '' . $slovnik->vyska_pozicky . '';
$snippet->pocet_splatok_label = '' . $slovnik->pocet_splatok . '';
$snippet->splatka_label = 'Počet dnů splácení';
