<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/multiform_cz/product_snippet_cache27247.latte

class Template265899681f165c6ec5a0f7c4863bd357 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('9379dd3ee0', 'html')
;
//
// main template
//
...
'1' => (object) array(
'text' => 'Nízké náklady na půjčku', 'popis' => '', 'ikona' => '', 'obrazok' => '',), 
)
?>
<div class="vyhody">
  <a id="vyhody"></a>
