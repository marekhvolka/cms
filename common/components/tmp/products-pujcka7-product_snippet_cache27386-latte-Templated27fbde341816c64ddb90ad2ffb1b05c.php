<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/pujcka7/product_snippet_cache27386.latte

class Templated27fbde341816c64ddb90ad2ffb1b05c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2d5bca54f9', 'html')
;
//
// main template
//
...
$snippet->vyska = '8 000 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '14';
$snippet->rpmn = '5 843.9 %';
$snippet->urok = '-';
$snippet->poplatok = '1 357 Kč';
$snippet->celkom = '9 357 Kč';
$snippet->splatnost = '6. 8. 2015';
