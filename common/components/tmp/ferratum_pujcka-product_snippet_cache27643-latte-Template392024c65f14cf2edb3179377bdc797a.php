<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/ferratum_pujcka/product_snippet_cache27643.latte

class Template392024c65f14cf2edb3179377bdc797a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3fd144952f', 'html')
;
//
// main template
//
