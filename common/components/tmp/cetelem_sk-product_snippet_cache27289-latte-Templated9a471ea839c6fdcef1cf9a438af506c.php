<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/cetelem_sk/product_snippet_cache27289.latte

class Templated9a471ea839c6fdcef1cf9a438af506c extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('817a77806b', 'html')
;
//
// main template
//
