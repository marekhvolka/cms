<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/ferratum_pozicka/product_snippet_cache27441.latte

class Templatec241408b3b29225861e364fdba17f0a7 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ab4790cf68', 'html')
;
//
// main template
//
...
'0' => (object) array(
'text' => 'fyzická osoba vo veku minimálne 21 rokov',), 
'1' => (object) array(
'text' => 'slovenské občianstvo a trvalý pobyt na území Slovenska',), 
'2' => (object) array(
