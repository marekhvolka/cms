<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/csob_pujcka/product_snippet_cache27654.latte

class Template1f034d4e2239618f4e7f68c476e58a39 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ad4c5265fe', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené hodnoty jsou čerpány z oficiální stránky poskytovatele k datu 12. 2. 2016.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '100 000 Kč', 'vyska' => '100 000 Kč', 'pocet_splatok' => '48', 'splatka' => '2 532 Kč', 'urok' => '9,9 %', 'poplatok' => '6 Kč', 'rpmn' => '10,5 %', 'celkom' => '121 824 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
