<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/smart_pujcka/product_snippet_cache27318.latte

class Templatebf11e1e128836b2c813b79b75df0b12a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4cae47c1d0', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '30 000 Kč', 'pocet_splatok' => '16', 'splatka' => '3 450 Kč', 'rpmn' => '163,38 %', 'urok' => '21 %', 'poplatok' => '16 800 Kč **', 'celkom' => '55 200 Kč', 'celkova_uspora' => '', 'splatnost' => '17. 8. 2016',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '30 000 Kč', 'pocet_splatok' => '13', 'splatka' => '3 900 Kč', 'rpmn' => '187,6 %', 'urok' => '25,85 %', 'poplatok' => '13 200 Kč **', 'celkom' => '51 600 Kč', 'celkova_uspora' => '', 'splatnost' => '17. 8. 2016',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '70 000 Kč', 'pocet_splatok' => '16', 'splatka' => '8 050 Kč', 'rpmn' => '163,38 %', 'urok' => '21 %', 'poplatok' => '39 202 Kč **', 'celkom' => '128 800 Kč', 'celkova_uspora' => '', 'splatnost' => '17. 11. 2016',), 
);
