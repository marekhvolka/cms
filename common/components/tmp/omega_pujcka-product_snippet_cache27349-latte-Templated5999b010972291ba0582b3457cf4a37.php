<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/omega_pujcka/product_snippet_cache27349.latte

class Templated5999b010972291ba0582b3457cf4a37 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('fffcb1e158', 'html')
;
//
// main template
//
...
$snippet->splatka = '30';
$snippet->rpmn = '2 333,95 % p.a.';
$snippet->urok = '30% p.m.';
$snippet->poplatok = '900 Kč';
$snippet->celkom = '3 900 Kč';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni: 14. 8. 2014';
