<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/raiffeisen_pujcka/product_snippet_cache27597.latte

class Templatee0b7208118049e0035bb26aec2b3272d extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('03908db63a', 'html')
;
//
// main template
//
...
$snippet->vyska = '20 000 Kč';
$snippet->pocet_splatok = '6';
$snippet->splatka = '3 441 Kč';
$snippet->urok = '10,9 %';
$snippet->poplatok = '0 Kč';
$snippet->rpmn = '11,6 %';
$snippet->celkom = '20 646 Kč';
