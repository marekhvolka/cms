<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/crediton_pujcka/product_snippet_cache27429.latte

class Templatee7bf4733897abfa93e6abed38ad6bdd5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('94af533725', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni: 3. 8. 2015. <br>** Půjčka jen pro opakovaného klienta.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '500 Kč', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '30341 %', 'urok' => '730 %', 'poplatok' => '300 Kč', 'celkom' => '800 Kč', 'celkova_uspora' => '', 'splatnost' => '2. 9. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '10 000 Kč **', 'pocet_splatok' => '1', 'splatka' => '20', 'rpmn' => '7346 %', 'urok' => '486 %', 'poplatok' => '2 664 Kč', 'celkom' => '12 664 Kč', 'celkova_uspora' => '', 'splatnost' => '23. 8. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '20 000 Kč **', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '5281 %', 'urok' => '472 %', 'poplatok' => '7 752 Kč', 'celkom' => '27 752 Kč', 'celkova_uspora' => '', 'splatnost' => '2. 9. 2015',), 
);
