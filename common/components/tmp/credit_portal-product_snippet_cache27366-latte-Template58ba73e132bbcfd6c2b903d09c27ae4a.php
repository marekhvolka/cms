<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/credit_portal/product_snippet_cache27366.latte

class Template58ba73e132bbcfd6c2b903d09c27ae4a extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1d64084fd6', 'html')
;
//
// main template
//
...
$snippet->vyska = '3 000 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '30 dní';
$snippet->rpmn = '9 090 %   ';
$snippet->urok = '-';
$snippet->poplatok = '1 350 Kč';
$snippet->celkom = '4 350 Kč';
$snippet->splatnost = '24. 8. 2015';
