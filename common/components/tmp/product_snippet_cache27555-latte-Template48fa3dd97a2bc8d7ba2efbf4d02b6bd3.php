<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/raiffeisen_bank_ucet/product_snippet_cache27555.latte

class Template48fa3dd97a2bc8d7ba2efbf4d02b6bd3 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('91dd08b85f', 'html')
;
//
// main template
//
