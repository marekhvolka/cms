<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/csob_sporiaci_ucet/product_snippet_cache27631.latte

class Template10847ac6e2bfe74b71f35b82e5d7d497 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ec15931918', 'html')
;
//
// main template
//
