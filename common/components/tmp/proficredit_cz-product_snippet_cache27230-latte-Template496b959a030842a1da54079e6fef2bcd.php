<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/proficredit_cz/product_snippet_cache27230.latte

class Template496b959a030842a1da54079e6fef2bcd extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('4f3d94773a', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '30 000 Kč', 'pocet_splatok' => '12', 'splatka' => '2 968 Kč', 'rpmn' => '38,38 %', 'urok' => '32,93 %', 'poplatok' => '-', 'celkom' => '35 616 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '24', 'splatka' => '5 743 Kč', 'rpmn' => '38,37 %', 'urok' => '32,93 %', 'poplatok' => '-', 'celkom' => '137 832 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '150 000 Kč', 'pocet_splatok' => '48', 'splatka' => '5 651 Kč', 'rpmn' => '38,25 %', 'urok' => '32,83 %', 'poplatok' => '-', 'celkom' => '271 248 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
