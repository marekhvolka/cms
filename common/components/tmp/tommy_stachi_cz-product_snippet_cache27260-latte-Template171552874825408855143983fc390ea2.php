<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/tommy_stachi_cz/product_snippet_cache27260.latte

class Template171552874825408855143983fc390ea2 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('411fb12431', 'html')
;
//
// main template
//
...
'text' => 'Zletilá osoba',), 
'1' => (object) array(
'text' => 'Trvalé bydliště na území ČR',), 
'2' => (object) array(
'text' => 'Stálý a dostatečný zdroj příjmu',), 
'3' => (object) array(
'text' => 'Doložení alespoň 2 dokladů totožnosti',), 
)
?>
<div class="vyhody">
  <a id="vyhody"></a>
