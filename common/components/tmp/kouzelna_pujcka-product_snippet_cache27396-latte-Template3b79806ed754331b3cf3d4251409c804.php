<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/kouzelna_pujcka/product_snippet_cache27396.latte

class Template3b79806ed754331b3cf3d4251409c804 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('471beac6f1', 'html')
;
//
// main template
//
...
'2' => (object) array(
'text' => 'Akceptace úvěrové smlouvy.', 'popis' => '', 'icon' => '', 'obrazok' => '',), 
'3' => (object) array(
