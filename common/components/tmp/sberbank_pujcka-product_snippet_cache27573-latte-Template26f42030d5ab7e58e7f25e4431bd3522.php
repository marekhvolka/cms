<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/sberbank_pujcka/product_snippet_cache27573.latte

class Template26f42030d5ab7e58e7f25e4431bd3522 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('aa12c5d48a', 'html')
;
//
// main template
//
...
$snippet->splatka = '4 763 Kč';
$snippet->urok = '12,99 %';
$snippet->poplatok = '0 Kč';
$snippet->rpmn = '14,00 %';
$snippet->celkom = '114 312 Kč';
