<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/unicredit_cz_presto/product_snippet_cache27419.latte

class Templatefdc30e15705edf30c35134604d3ce045 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('080966fe16', 'html')
;
//
// main template
//
...
$snippet->vyska = '500 000 Kč';
$snippet->pocet_splatok = '12';
$snippet->splatka = '44 184 Kč';
$snippet->rpmn = '15,54 %';
$snippet->urok = '10,40 %';
$snippet->poplatok = '1 500 Kč ';
$snippet->celkom = '534 494 Kč';
