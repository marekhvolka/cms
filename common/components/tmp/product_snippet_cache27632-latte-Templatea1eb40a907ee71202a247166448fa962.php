<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/mbank_sporiaci_ucet_emax/product_snippet_cache27632.latte

class Templatea1eb40a907ee71202a247166448fa962 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('243c20150f', 'html')
;
//
// main template
//
