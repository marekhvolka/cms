<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/sberbank_pozicka/product_snippet_cache27475.latte

class Template27b90dae5b18e50f94e6894904b959a6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e97c58a58b', 'html')
;
//
// main template
//
...
$snippet->vyska = '3 500 €';
$snippet->pocet_splatok = '108';
$snippet->splatka = '44,29 €';
$snippet->rpmn = '7,92 %';
$snippet->urok = '8,29 %';
$snippet->poplatok = '50 €';
$snippet->celkom = '4 833 €';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 14. 7. 2015. <br>';
