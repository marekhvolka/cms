<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/vitacredit_pujcka/product_snippet_cache27403.latte

class Templatefe9b6cdcd534318413a8339f141dd281 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('55f314adcd', 'html')
;
//
// main template
//
...
$snippet->splatka = '4 393 Kč';
$snippet->rpmn = '29,8 %';
$snippet->urok = '9,9 %';
$snippet->poplatok = '4 100 Kč';
$snippet->celkom = '56 816 Kč';
