<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/acema_pujcka/product_snippet_cache27363.latte

class Template1e4beb943331e2fe4da14ec367a4cc51 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('baf3651a72', 'html')
;
//
// main template
//
...
$snippet->pocet_splatok = '96';
$snippet->splatka = '1 619 Kč';
$snippet->rpmn = '21,37 % p.a.';
$snippet->urok = '11,88 % p.m.';
$snippet->poplatok = '31 104 Kč';
$snippet->celkom = '186 528 Kč';
$snippet->splatnost = '1. 7. 2023';
$snippet->platnost = '*Uvedené údaje jsou čerpány z oficiální stránky partnera ke dni 2. 6. 2015';
