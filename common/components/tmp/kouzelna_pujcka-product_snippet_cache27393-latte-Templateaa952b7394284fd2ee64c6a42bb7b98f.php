<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/kouzelna_pujcka/product_snippet_cache27393.latte

class Templateaa952b7394284fd2ee64c6a42bb7b98f extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('114efc42e9', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '1 000 Kč', 'pocet_splatok' => '1', 'splatka' => '15', 'rpmn' => '-', 'urok' => '361.35 %', 'poplatok' => '149 Kč', 'celkom' => '1 149 Kč  ', 'celkova_uspora' => '', 'splatnost' => '22. 7. 2015',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '5 000 Kč', 'pocet_splatok' => '1', 'splatka' => '10', 'rpmn' => '-', 'urok' => '361.35 % ', 'poplatok' => '743 Kč  ', 'celkom' => '5 743 Kč  ', 'celkova_uspora' => '', 'splatnost' => '17. 7. 2015',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '10 000 Kč', 'pocet_splatok' => '1', 'splatka' => '30', 'rpmn' => '-', 'urok' => '361.35 %', 'poplatok' => '2 970 Kč', 'celkom' => '12 970 Kč  ', 'celkova_uspora' => '', 'splatnost' => '6. 8. 2015',), 
);
...
$snippet->poplatok_label = 'Úrok a poplatek';
