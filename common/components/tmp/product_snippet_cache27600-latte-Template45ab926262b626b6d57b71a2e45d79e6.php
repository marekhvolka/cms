<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/cetelem_konsolidace_pujcek/product_snippet_cache27600.latte

class Template45ab926262b626b6d57b71a2e45d79e6 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('abb6939c62', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => 'Původní úvěr', 'vyska' => '80 000 Kč', 'pocet_splatok' => '22', 'splatka' => '5 341 Kč', 'urok' => '20,08 %', 'poplatok' => '20 188 Kč', 'rpmn' => '53,40 %', 'celkom' => '117 483 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => 'Nabídka od Cetelem', 'vyska' => '80 000 Kč', 'pocet_splatok' => '22', 'splatka' => '3 991 Kč', 'urok' => '9,9 %', 'poplatok' => '', 'rpmn' => '10,35 %', 'celkom' => '87 802 Kč', 'celkova_uspora' => '29 681 Kč', 'splatnost' => '',), 
);
...
$snippet->celkova_uspora_label = 'Odměna za splácení';
