<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/sberbank_refinancovani/product_snippet_cache27549.latte

class Template27e654c8eee6b6fc059db71f190987a8 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('57a289742d', 'html')
;
//
// main template
//
...
$snippet->vyska = '186 000 Kč';
$snippet->pocet_splatok = '83 měsíců';
$snippet->splatka = '3 126 Kč';
$snippet->rpmn = '10,61 %';
$snippet->urok = '9,99 %';
$snippet->platnost = 'Reprezentativní příklad je čerpán z oficiální stránky poskytovatele k datu: 13. 11. 2015.';
