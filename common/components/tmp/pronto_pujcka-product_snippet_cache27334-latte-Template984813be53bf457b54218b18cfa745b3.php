<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/pronto_pujcka/product_snippet_cache27334.latte

class Template984813be53bf457b54218b18cfa745b3 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f58a24ec75', 'html')
;
//
// main template
//
