<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/unicredit_cz_presto_konsolidace/product_snippet_cache27538.latte

class Template1e07e9dfb226700f846a4e6c79a52312 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e9d7b0bf9f', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => 'Aktuální výše závazku   ', 'vyska' => '180 000 Kč   ', 'pocet_splatok' => '84 ', 'splatka' => '4 000 Kč', 'rpmn' => '', 'urok' => '', 'poplatok' => '', 'celkom' => '336 143 Kč', 'celkova_uspora' => '-', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => 'Nová nabídka', 'vyska' => '180 000 Kč   ', 'pocet_splatok' => '84', 'splatka' => '2 987 Kč', 'rpmn' => '', 'urok' => '', 'poplatok' => '', 'celkom' => '251 222 Kč', 'celkova_uspora' => '84 921 Kč', 'splatnost' => '',), 
);
