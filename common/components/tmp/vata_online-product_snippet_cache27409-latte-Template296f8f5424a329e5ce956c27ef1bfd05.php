<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/vata_online/product_snippet_cache27409.latte

class Template296f8f5424a329e5ce956c27ef1bfd05 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('319185caa9', 'html')
;
//
// main template
//
...
$snippet->vyska = '4 500 Kč';
$snippet->pocet_splatok = '1';
$snippet->splatka = '20';
$snippet->rpmn = '2 686 %';
$snippet->urok = '1 % denně';
$snippet->poplatok = '900 Kč';
$snippet->celkom = '5 400 Kč';
$snippet->splatnost = '13. 8. 2015';
