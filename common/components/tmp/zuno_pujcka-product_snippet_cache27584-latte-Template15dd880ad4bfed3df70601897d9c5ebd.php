<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/zuno_pujcka/product_snippet_cache27584.latte

class Template15dd880ad4bfed3df70601897d9c5ebd extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('6966374125', 'html')
;
//
// main template
//
...
$snippet->splatka = '4 610 Kč';
$snippet->urok = '9,9 %';
$snippet->poplatok = '0 Kč';
$snippet->celkom = '110 640 Kč';
