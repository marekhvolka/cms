<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/msporenie/product_snippet_cache27628.latte

class Template8a1b07bffa58d42a2c3fcc2c9eb4c712 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8de4c553c1', 'html')
;
//
// main template
//
