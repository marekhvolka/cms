<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/konsolidace_pujcek_ge_money_bank/product_snippet_cache27545.latte

class Template41eb4d465a6ce52d49de42097276db8e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('c1378e8b7c', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené hodnoty jsou jsou čerpány z oficiální stránky poskytovatele k datu 10. 11. 2015.';
...
'1' => (object) array(
'ponuka' => 'Nová nabídka', 'vyska' => '180 000 Kč   ', 'pocet_splatok' => '84', 'splatka' => '3 313,82 Kč', 'urok' => '', 'poplatok' => '', 'rpmn' => '', 'celkom' => '280 155,88 Kč', 'celkova_uspora' => '69 191 Kč', 'splatnost' => '',), 
);
