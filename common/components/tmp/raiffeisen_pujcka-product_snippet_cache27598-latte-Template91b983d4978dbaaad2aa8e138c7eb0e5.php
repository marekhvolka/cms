<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/raiffeisen_pujcka/product_snippet_cache27598.latte

class Template91b983d4978dbaaad2aa8e138c7eb0e5 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('d99c1648b9', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené hodnoty jsou čerpány z oficiální stránky poskytovatele k datu 14. 12. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '20 000 Kč', 'pocet_splatok' => '6', 'splatka' => '3 441 Kč', 'urok' => '10,9 %', 'poplatok' => '0 Kč', 'rpmn' => '11,5 %', 'celkom' => '20 646 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '300 000 Kč', 'pocet_splatok' => '48', 'splatka' => '7 740 Kč', 'urok' => '10,9 %', 'poplatok' => '0 Kč', 'rpmn' => '11,5 %', 'celkom' => '371 520 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
'2' => (object) array(
'ponuka' => '', 'vyska' => '500 000 Kč', 'pocet_splatok' => '96', 'splatka' => '7 828 Kč', 'urok' => '10,9 %', 'poplatok' => '0 Kč', 'rpmn' => '11,5 %', 'celkom' => '751 488 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
