<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/cz/products/tommy_stachi_cz/product_snippet_cache27259.latte

class Template6f7f2309a9ba9568718a8bbbebc9ba77 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('b8b2478995', 'html')
;
//
// main template
//
...
'0' => (object) array(
'ponuka' => '', 'vyska' => '100 000 Kč', 'pocet_splatok' => '24', 'splatka' => '5 540 Kč', 'rpmn' => '33.2 %', 'urok' => '29 %', 'poplatok' => '-', 'celkom' => '132 959 Kč', 'celkova_uspora' => '', 'splatnost' => '',), 
);
