<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/unicredit_refinancovanie_hypoteky/product_snippet_cache27428.latte

class Templateff752bf46d909a6c98d0b045a1ed6df4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e42cbafa4a', 'html')
;
//
// main template
//
...
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 27. 7. 2015.';
$snippet->priklady =  array(
'0' => (object) array(
'ponuka' => '', 'vyska' => '60 000 €', 'pocet_splatok' => '20 rokov', 'splatka' => '550 €', 'rpmn' => '-', 'urok' => '2,49 %', 'poplatok' => '', 'celkom' => '', 'celkova_uspora' => '', 'splatnost' => '',), 
'1' => (object) array(
'ponuka' => '', 'vyska' => '60 000 €', 'pocet_splatok' => '20', 'splatka' => '304 € **', 'rpmn' => '-', 'urok' => '1,69 %', 'poplatok' => '', 'celkom' => '2 952 €', 'celkova_uspora' => '', 'splatnost' => '',), 
);
$snippet->vyska_label = '' . $slovnik->vyska_pozicky . '';
$snippet->pocet_splatok_label = 'Splatnosť v rokoch';
...
$snippet->celkom_label = 'Za 1 rok ušetríte';
