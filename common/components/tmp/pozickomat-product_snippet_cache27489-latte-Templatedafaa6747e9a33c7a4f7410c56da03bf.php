<?php
// source: /Users/MarekHvolka/Sites/cms/frontend/web/cache/sk/products/pozickomat/product_snippet_cache27489.latte

class Templatedafaa6747e9a33c7a4f7410c56da03bf extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('927ecf1717', 'html')
;
//
// main template
//
...
$snippet->rpmn = '29,1 %';
$snippet->urok = '0 %';
$snippet->poplatok = '2,46 €';
$snippet->celkom = '352,46 €';
$snippet->splatnost = '12. 9. 2015';
$snippet->platnost = '*Uvedené údaje sú čerpané z oficiálnej stránky partnera ku dňu 2. 9. 2015.';
